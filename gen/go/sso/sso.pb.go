...
type RegisterRequest struct {
	...
	Email         string                 `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`       // Почта пользователя при регистрации
	Password      string                 `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` // Пароль пользователя при регистрации
...
var file_sso_sso_proto_rawDesc = string([]byte{
	...
	0x5a, 0x13, 0x76, 0x65, 0x79, 0x6c, 0x69, 0x6e, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b,
